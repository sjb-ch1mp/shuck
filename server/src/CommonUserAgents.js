//https://developers.whatismybrowser.com/useragents/explore/software_type_specific/web-browser/2#google_vignette
...
function getRandomUserAgent(){
    return commonUserAgents[Math.floor(Math.random() * commonUserAgents.length - 1)];
}
